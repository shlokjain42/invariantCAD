...
OCCT-trap injection, trusted-host isolation, durable subshape identity, a
cross-platform golden matrix, evaluator/cache integration, compatibility
certification, or operational-cancellation certification.
...
cache integration, durable artifact-local identity, or cross-platform matrix
has been added.
