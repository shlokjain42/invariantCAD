...
runtime differences must fail exact matching.
...
- process sandboxing, live/peak-memory bounds, prompt same-thread cancellation,
  geometry correctness, durable symmetric-subshape identity, or cross-platform
...
evidence a compatibility certificate. Isolation, attestation, semantic
identity, cross-platform goldens, and evaluator/cache integration remain
separate gates.
