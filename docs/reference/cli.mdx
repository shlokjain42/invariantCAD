...
Inline values use finite JSON-number syntax. Parameter names use the same ID
grammar as authored parameters. Lengths are millimetres, angles are radians,
mass density is `kg/mm³`, and scalars are unitless.
