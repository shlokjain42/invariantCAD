...
foreign definitions, an authoring limit is exceeded, or a parameter,
...
rejected rather than silently discarded. Successful build detaches caller
metadata and collections before recursively freezing the document.
