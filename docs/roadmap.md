...
- Bounded exact solid sweeps along explicit open 3D polyline paths with corrected-Frenet transport and right-corner transitions
...
- Smooth/curved/guided sweep modes, smooth/guided/open or holed loft modes, pipe, and two-dimensional wire/profile offset
