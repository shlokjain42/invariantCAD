...
- Landed: an owned facade ABI 0.6 exact-evolution persistence matrix covering inherited Boolean, fillet/chamfer, shell, and draft semantic survival; downstream consumers; generated edge-treatment/shell/offset geometry-only baselines; key-free disappearance and recovery; serialization; and native arena cleanup
