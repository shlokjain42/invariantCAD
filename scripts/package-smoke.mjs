...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'void [currentNodeAlias, currentSweepEdgeRole, currentSweepFaceRole, currentSweepRole, currentSweepTopologyQuery, currentSweepTopologySelection, currentTopologyNode, currentTopologySelection, documentLimits, explainedTopologyKey, legacyTopologyQuery, loftTopologyQueryV3, persistentTopologyQueryV2, persistentTopologyReference, resolvedTopologyReference, sweepTopologyQueryV4, topologyExplanation, topologyExplanationBase, topologyExplanationVersion, topologyReference, topologySession, topologySignatureLimits, topologyStrategySummary];',
      "",
