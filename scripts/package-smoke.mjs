...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { createEvaluator, design, mm, scalarVec3, stringifyDocument, topology, vec3 } from "invariantcad";',
  ...
  await writeFile(
    ...
    [
      'import { design, mm, scalarVec3, topology, vec3, type DesignDocument, type SolidRef } from "invariantcad";',
